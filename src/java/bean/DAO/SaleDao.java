...
public class SaleDao {
   ...
   public static List<String> getMostRevenueEmployee() throws SQLException{
    ...
    public static List<String> revenueSummaryByItemType(String itemtype) throws SQLException{
        List<String> transactions = new ArrayList<String>();
        Connection conn = null;
        try{
            InitialContext ctx = new InitialContext();
    ...
    public static List<String> getBestSellerItems() throws SQLException {
        ...
        try{
            ...
            DataSource ds = (DataSource)ctx.lookup("Bazaar_Application_Connection");
            conn = (Connection) ds.getConnection();
            PreparedStatement ps = conn.prepareStatement("select * from bestSellers");
