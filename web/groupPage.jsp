    ...
    <body>
           ...
           <div class="container-fluid">
            ...
            <div class="row">
                 ...
                 <form action="PostResponse.jsp">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="postcontent" class="form-control" id="postcontentInput" rows="3"></textarea>
                             ...
                             <input type ="hidden" name="id" value="<%out.print(PageDao.getPageIdFromGroupId(grp.getId())); %>">
                        </div>
             ...
             <% 
            List<Post> posts = PageDao.GetPosts( PageDao.getPageIdFromGroupId(grp.getId()));
                for(Post p : posts){
